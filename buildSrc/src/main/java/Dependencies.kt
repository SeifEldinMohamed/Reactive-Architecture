...
object BuildPlugins {
    ...
    val jacocoPlugin =  "com.vanniktech:gradle-android-junit-jacoco-plugin:${Versions.JACOCO}" // for core conversion
...
object Android {
    ...
    const val applicationId = "com.seif.reactivearchitecture"
}
